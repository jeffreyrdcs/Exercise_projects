...
class CredEntry():
    ...
    def __init__(self, title='dummy', user='dummy', password='dummy', description='dummy', category='dummy'):
        self.title = title
        self.user = user
    ...
    def user_input(self, check_existing_title_flag=False, list_existing_category_flag=False, encrypt_password=False):
        # Title 
