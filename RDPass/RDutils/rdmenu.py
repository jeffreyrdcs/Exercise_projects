...
from .rddb import list_existing_category, add_entry_command, update_entry_command, delete_entry_command, list_entry_command, logout_db, select_db_from_list, create_new_db



def load_login_menu(db_avail_list):
	"""
	...
	if command == 'l':
		sel_db_name = select_db_from_list(db_avail_list)
		return sel_db_name
	elif command == 'c':
